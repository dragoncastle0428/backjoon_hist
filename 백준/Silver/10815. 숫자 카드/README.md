...
### 해결방법
 ...
 <p>Set data structure를 이용해서 푸는 것이 적절하다. if .. in .. 이 set이나 hash일 떄 time complexity가 가장 낮은데 처음 받는 리스트를 set 형태로 바꿔 사용하는 것이 좋다.</p>
